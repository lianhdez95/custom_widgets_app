    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.search), label: 'Screen B'),
          BottomNavigationBarItem(icon: Icon(Icons.cases_outlined), label: 'Screen C'),
          BottomNavigationBarItem(icon: Icon(Icons.person), label: 'Screen D'),
        ],
